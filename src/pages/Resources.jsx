...
import { BarChart3, BookOpen, Download, FileText, HeartPulse } from "lucide-react";
import { api } from "../api";
              ...
              <Card key={m.id}>
                <div className="flex gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <a
                      href={api.materialFileUrl(m.id)}
                      className="mt-4 inline-flex items-center gap-1.5 text-xs font-bold text-[#7c3aed]"
                    >
